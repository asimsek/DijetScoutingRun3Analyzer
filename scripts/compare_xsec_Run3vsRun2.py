...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--zoom-x-min-gev", type=float, default=565.0,    help="Zoomed plot x-axis minimum [GeV].")
    parser.add_argument("--zoom-x-max-gev", type=float, default=2000.0,    help="Zoomed plot x-axis maximum [GeV].")
    parser.add_argument("--overlay-x-min-gev", type=float, default=565.0,  help="Overlay plot x-axis minimum [GeV].")
    parser.add_argument("--overlay-x-max-gev", type=float, default=2000.0, help="Overlay plot x-axis maximum [GeV].")
    ...
    parser.add_argument("--norm-top-y-min", type=float, default=-15.0,       help="Normalized top-only plot y-axis minimum.")
    parser.add_argument("--norm-top-y-max", type=float, default=20.0,     help="Normalized top-only plot y-axis maximum.")
