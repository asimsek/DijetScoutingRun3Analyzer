...
// Tue Feb 24 10:48:45 2026 by ROOT version 6.32.13
// from TChain Events/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nL1Jet;
   Short_t         L1Jet_bx[39];   //[nL1Jet]
   Float_t         L1Jet_eta[39];   //[nL1Jet]
   Float_t         L1Jet_phi[39];   //[nL1Jet]
   Float_t         L1Jet_pt[39];   //[nL1Jet]
   Int_t           nL1Mu;
   Short_t         L1Mu_hwCharge[13];   //[nL1Mu]
   Short_t         L1Mu_hwDXY[13];   //[nL1Mu]
   Short_t         L1Mu_bx[13];   //[nL1Mu]
   Int_t           L1Mu_hwQual[13];   //[nL1Mu]
   Float_t         L1Mu_eta[13];   //[nL1Mu]
   Float_t         L1Mu_etaAtVtx[13];   //[nL1Mu]
   Float_t         L1Mu_phi[13];   //[nL1Mu]
   Float_t         L1Mu_phiAtVtx[13];   //[nL1Mu]
   Float_t         L1Mu_pt[13];   //[nL1Mu]
   Float_t         L1Mu_ptUnconstrained[13];   //[nL1Mu]
   Int_t           nL1Tau;
   ...
   Bool_t          ScoutingElectron_rechitZeroSuppression[13];   //[nScoutingElectron]
   Int_t           ScoutingElectron_missingHits[13];   //[nScoutingElectron]
   Int_t           ScoutingElectron_bestTrack_charge[13];   //[nScoutingElectron]
   UInt_t          ScoutingElectron_nClusters[13];   //[nScoutingElectron]
   UInt_t          ScoutingElectron_nCrystals[13];   //[nScoutingElectron]
   UInt_t          ScoutingElectron_seedId[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_corrEcalEnergyError[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_dEtaIn[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_dPhiIn[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_ecalIso[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_eta[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_hOverE[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_hcalIso[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_m[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_ooEMOop[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_phi[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_preshowerEnergy[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_pt[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_r9[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_rawEnergy[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_sMaj[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_sMin[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_sigmaIetaIeta[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_trackIso[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_trackfbrem[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_chi2overndf[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_d0[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_dz[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_eta[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_etaMode[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_pMode[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_phi[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_phiMode[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_pt[13];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_qoverpModeError[13];   //[nScoutingElectron]
   ...
   Bool_t          ScoutingMuonNoVtxDisplacedVertex_isValidVtx[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Int_t           ScoutingMuonNoVtxDisplacedVertex_ndof[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Int_t           ScoutingMuonNoVtxDisplacedVertex_tracksSize[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_chi2[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_x[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_xError[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_xyCov[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_xzCov[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_y[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_yError[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_yzCov[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_z[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_zError[20];   //[nScoutingMuonNoVtxDisplacedVertex]
   ...
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_beginTrackHits[8];   //[nScoutingMuonNoVtx]
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_endInner[8];   //[nScoutingMuonNoVtx]
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_endOuter[8];   //[nScoutingMuonNoVtx]
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_endTrackHits[8];   //[nScoutingMuonNoVtx]
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_hitCount[8];   //[nScoutingMuonNoVtx]
   UShort_t        ScoutingMuonNoVtx_nScoutingMuonNoVtxHitPattern[8];   //[nScoutingMuonNoVtx]
   UShort_t        ScoutingMuonNoVtx_oScoutingMuonNoVtxHitPattern[8];   //[nScoutingMuonNoVtx]
   UShort_t        ScoutingMuonNoVtx_nScoutingMuonNoVtxVtxIndx[8];   //[nScoutingMuonNoVtx]
   UShort_t        ScoutingMuonNoVtx_oScoutingMuonNoVtxVtxIndx[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_charge[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nPixelLayersWithMeasurement[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonChambers[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonChambersCSCorDT[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonExpectedMatchedStations[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonMatchedRPCLayers[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonMatchedStations[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonMatches[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nStandAloneMuonMatchedStations[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nTrackerLayersWithMeasurement[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nValidPixelHits[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nValidRecoMuonHits[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nValidStandAloneMuonHits[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nValidStripHits[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_recoMuonRPClayerMask[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_recoMuonStationMask[8];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_type[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_ecalIso[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_eta[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_hcalIso[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_m[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_normchi2[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_phi[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_pt[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trackIso[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_chi2[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dsz[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dszError[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dxy[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dxyError[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dxy_dsz_cov[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dz[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dzError[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_eta[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_lambda[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_lambdaError[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_lambda_dsz_cov[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_lambda_dxy_cov[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_lambda_phi_cov[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_ndof[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_phi[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_phiError[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_phi_dsz_cov[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_phi_dxy_cov[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_pt[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverp[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverpError[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverp_dsz_cov[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverp_dxy_cov[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverp_lambda_cov[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverp_phi_cov[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_vx[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_vy[8];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_vz[8];   //[nScoutingMuonNoVtx]
   ...
   Int_t           ScoutingMuonNoVtxVtxIndx_vtxIndx[40];   //[nScoutingMuonNoVtxVtxIndx]
   ...
   UChar_t         ScoutingMuonVtx_trk_hitPattern_beginInner[9];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_beginOuter[9];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_beginTrackHits[9];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_endInner[9];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_endOuter[9];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_endTrackHits[9];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_hitCount[9];   //[nScoutingMuonVtx]
   UShort_t        ScoutingMuonVtx_nScoutingMuonVtxHitPattern[9];   //[nScoutingMuonVtx]
   UShort_t        ScoutingMuonVtx_oScoutingMuonVtxHitPattern[9];   //[nScoutingMuonVtx]
   UShort_t        ScoutingMuonVtx_nScoutingMuonVtxVtxIndx[9];   //[nScoutingMuonVtx]
   UShort_t        ScoutingMuonVtx_oScoutingMuonVtxVtxIndx[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_charge[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nPixelLayersWithMeasurement[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonChambers[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonChambersCSCorDT[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonExpectedMatchedStations[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonMatchedRPCLayers[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonMatchedStations[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonMatches[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nStandAloneMuonMatchedStations[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nTrackerLayersWithMeasurement[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nValidPixelHits[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nValidRecoMuonHits[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nValidStandAloneMuonHits[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nValidStripHits[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_recoMuonRPClayerMask[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_recoMuonStationMask[9];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_type[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_ecalIso[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_eta[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_hcalIso[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_m[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_normchi2[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_phi[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_pt[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trackIso[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_chi2[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dsz[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dszError[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dxy[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dxyError[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dxy_dsz_cov[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dz[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dzError[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_eta[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_lambda[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_lambdaError[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_lambda_dsz_cov[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_lambda_dxy_cov[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_lambda_phi_cov[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_ndof[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_phi[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_phiError[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_phi_dsz_cov[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_phi_dxy_cov[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_pt[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverp[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverpError[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverp_dsz_cov[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverp_dxy_cov[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverp_lambda_cov[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverp_phi_cov[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_vx[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_vy[9];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_vz[9];   //[nScoutingMuonVtx]
   Int_t           nScoutingMuonVtxHitPattern;
   UShort_t        ScoutingMuonVtxHitPattern_hitPattern[513];   //[nScoutingMuonVtxHitPattern]
   Int_t           nScoutingMuonVtxVtxIndx;
   Int_t           ScoutingMuonVtxVtxIndx_vtxIndx[1];   //[nScoutingMuonVtxVtxIndx]
   Int_t           nScoutingPFJetRecluster;
   UChar_t         ScoutingPFJetRecluster_nConstituents[51];   //[nScoutingPFJetRecluster]
   Int_t           ScoutingPFJetRecluster_nCh[51];   //[nScoutingPFJetRecluster]
   Int_t           ScoutingPFJetRecluster_nElectrons[51];   //[nScoutingPFJetRecluster]
   Int_t           ScoutingPFJetRecluster_nMuons[51];   //[nScoutingPFJetRecluster]
   Int_t           ScoutingPFJetRecluster_nNh[51];   //[nScoutingPFJetRecluster]
   Int_t           ScoutingPFJetRecluster_nPhotons[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_area[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_chEmEF[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_chHEF[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_eta[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_hfEmEF[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_hfHEF[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_mass[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_muEF[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_neEmEF[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_neHEF[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_phi[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_pt[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_b[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_bb[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_c[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_cc[51];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_g[51];   //[nScoutingPFJetRecluster]
   ...
   Bool_t          ScoutingPhoton_rechitZeroSuppression[37];   //[nScoutingPhoton]
   UInt_t          ScoutingPhoton_nClusters[37];   //[nScoutingPhoton]
   UInt_t          ScoutingPhoton_nCrystals[37];   //[nScoutingPhoton]
   UInt_t          ScoutingPhoton_seedId[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_corrEcalEnergyError[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_ecalIso[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_eta[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_hOverE[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_hcalIso[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_m[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_phi[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_preshowerEnergy[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_pt[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_r9[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_rawEnergy[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_sMaj[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_sMin[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_sigmaIetaIeta[37];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_trkIso[37];   //[nScoutingPhoton]
   Int_t           nScoutingPrimaryVertex;
   Bool_t          ScoutingPrimaryVertex_isValidVtx[65];   //[nScoutingPrimaryVertex]
   Int_t           ScoutingPrimaryVertex_ndof[65];   //[nScoutingPrimaryVertex]
   Int_t           ScoutingPrimaryVertex_tracksSize[65];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_chi2[65];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_x[65];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_xError[65];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_xyCov[65];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_xzCov[65];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_y[65];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_yError[65];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_yzCov[65];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_z[65];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_zError[65];   //[nScoutingPrimaryVertex]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("root://cms-xrd-global.cern.ch//store/data/Run2024H/ScoutingPFRun3/NANOAOD/ScoutNano-v1/2520000/03e073d9-ab61-450d-aa10-fa050e94a16b.root/Events");
      tree = chain;
#endif // SINGLE_TREE
