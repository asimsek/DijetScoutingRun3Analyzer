...
// Tue Feb 24 07:00:09 2026 by ROOT version 6.32.13
// from TChain Events/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nCorrT1METJet;
   Float_t         CorrT1METJet_EmEF[14];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_area[14];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_eta[14];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrFactor[14];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_phi[14];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_rawPt[14];   //[nCorrT1METJet]
   ...
   Int_t           nGenPart;
   Short_t         GenPart_genPartIdxMother[187];   //[nGenPart]
   UShort_t        GenPart_statusFlags[187];   //[nGenPart]
   Int_t           GenPart_pdgId[187];   //[nGenPart]
   Int_t           GenPart_status[187];   //[nGenPart]
   Float_t         GenPart_eta[187];   //[nGenPart]
   Float_t         GenPart_mass[187];   //[nGenPart]
   Float_t         GenPart_phi[187];   //[nGenPart]
   Float_t         GenPart_pt[187];   //[nGenPart]
   Float_t         GenPart_iso[187];   //[nGenPart]
   Int_t           nGenProton;
   ...
   Int_t           nJet;
   UChar_t         Jet_chMultiplicity[20];   //[nJet]
   UChar_t         Jet_jetId[20];   //[nJet]
   UChar_t         Jet_nConstituents[20];   //[nJet]
   UChar_t         Jet_nElectrons[20];   //[nJet]
   UChar_t         Jet_nMuons[20];   //[nJet]
   UChar_t         Jet_nSVs[20];   //[nJet]
   UChar_t         Jet_neMultiplicity[20];   //[nJet]
   Short_t         Jet_electronIdx1[20];   //[nJet]
   Short_t         Jet_electronIdx2[20];   //[nJet]
   Short_t         Jet_muonIdx1[20];   //[nJet]
   Short_t         Jet_muonIdx2[20];   //[nJet]
   Short_t         Jet_svIdx1[20];   //[nJet]
   Short_t         Jet_svIdx2[20];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[20];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[20];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorr[20];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorrNeutrino[20];   //[nJet]
   Float_t         Jet_PNetRegPtRawRes[20];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorr[20];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorrNeutrino[20];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawRes[20];   //[nJet]
   Float_t         Jet_area[20];   //[nJet]
   Float_t         Jet_btagDeepFlavB[20];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[20];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[20];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[20];   //[nJet]
   Float_t         Jet_btagPNetB[20];   //[nJet]
   Float_t         Jet_btagPNetCvB[20];   //[nJet]
   Float_t         Jet_btagPNetCvL[20];   //[nJet]
   Float_t         Jet_btagPNetCvNotB[20];   //[nJet]
   Float_t         Jet_btagPNetQvG[20];   //[nJet]
   Float_t         Jet_btagPNetTauVJet[20];   //[nJet]
   Float_t         Jet_btagUParTAK4B[20];   //[nJet]
   Float_t         Jet_btagUParTAK4CvB[20];   //[nJet]
   Float_t         Jet_btagUParTAK4CvL[20];   //[nJet]
   Float_t         Jet_btagUParTAK4CvNotB[20];   //[nJet]
   Float_t         Jet_btagUParTAK4QvG[20];   //[nJet]
   Float_t         Jet_btagUParTAK4TauVJet[20];   //[nJet]
   ...
   Float_t         Jet_hfsigmaEtaEta[20];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[20];   //[nJet]
   Float_t         Jet_mass[20];   //[nJet]
   Float_t         Jet_muEF[20];   //[nJet]
   Float_t         Jet_muonSubtrFactor[20];   //[nJet]
   ...
   Float_t         Muon_softMva[20];   //[nMuon]
   Float_t         Muon_softMvaRun3[20];   //[nMuon]
   Float_t         Muon_tkRelIso[20];   //[nMuon]
   Float_t         Muon_tunepRelPt[20];   //[nMuon]
   Float_t         Muon_bsConstrainedChi2[20];   //[nMuon]
   Float_t         Muon_bsConstrainedPt[20];   //[nMuon]
   Float_t         Muon_bsConstrainedPtErr[20];   //[nMuon]
   Float_t         Muon_mvaLowPt[20];   //[nMuon]
   Float_t         Muon_promptMVA[20];   //[nMuon]
   Float_t         PFMET_covXX;
   Float_t         PFMET_covXY;
   Float_t         PFMET_covYY;
   Float_t         PFMET_phi;
   ...
   Int_t           nTrigObj;
   Short_t         TrigObj_l1charge[124];   //[nTrigObj]
   UShort_t        TrigObj_id[124];   //[nTrigObj]
   Int_t           TrigObj_l1iso[124];   //[nTrigObj]
   Int_t           TrigObj_filterBits[124];   //[nTrigObj]
   Float_t         TrigObj_pt[124];   //[nTrigObj]
   Float_t         TrigObj_eta[124];   //[nTrigObj]
   Float_t         TrigObj_phi[124];   //[nTrigObj]
   Float_t         TrigObj_l1pt[124];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[124];   //[nTrigObj]
   Float_t         TrigObj_l2pt[124];   //[nTrigObj]
   Float_t         TrkMET_phi;
   Float_t         TrkMET_pt;
   ...
   UChar_t         GenJetAK8_nBHadrons[8];   //[nGenJetAK8]
   UChar_t         GenJetAK8_nCHadrons[8];   //[nGenJetAK8]
   Short_t         GenJetAK8_partonFlavour[8];   //[nGenJetAK8]
   ...
   Float_t         GenVtx_t0;
   UChar_t         Jet_hadronFlavour[20];   //[nJet]
   Short_t         Jet_genJetIdx[20];   //[nJet]
   Short_t         Jet_partonFlavour[20];   //[nJet]
   ...
   Short_t         Muon_genPartIdx[20];   //[nMuon]
   Float_t         Muon_IPx[20];   //[nMuon]
   Float_t         Muon_IPy[20];   //[nMuon]
   Float_t         Muon_IPz[20];   //[nMuon]
   Float_t         Muon_ipLengthSig[20];   //[nMuon]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("root://cms-xrd-global.cern.ch//store/mc/RunIII2024Summer24NanoAOD/QCD_Bin-PT-1000to1500_TuneCP5_13p6TeV_pythia8/NANOAODSIM/140X_mcRun3_2024_realistic_v26-v2/120000/00ba6769-d1a4-4faa-be8f-2157b2a039d7.root/Events");
      tree = chain;
#endif // SINGLE_TREE
