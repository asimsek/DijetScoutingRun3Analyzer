...
// Mon Apr  6 07:23:14 2026 by ROOT version 6.32.13
// from TChain Events/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nL1Jet;
   Short_t         L1Jet_bx[42];   //[nL1Jet]
   Float_t         L1Jet_eta[42];   //[nL1Jet]
   Float_t         L1Jet_phi[42];   //[nL1Jet]
   Float_t         L1Jet_pt[42];   //[nL1Jet]
   Int_t           nL1Mu;
   Short_t         L1Mu_hwCharge[15];   //[nL1Mu]
   Short_t         L1Mu_hwDXY[15];   //[nL1Mu]
   Short_t         L1Mu_bx[15];   //[nL1Mu]
   Int_t           L1Mu_hwQual[15];   //[nL1Mu]
   Float_t         L1Mu_eta[15];   //[nL1Mu]
   Float_t         L1Mu_etaAtVtx[15];   //[nL1Mu]
   Float_t         L1Mu_phi[15];   //[nL1Mu]
   Float_t         L1Mu_phiAtVtx[15];   //[nL1Mu]
   Float_t         L1Mu_pt[15];   //[nL1Mu]
   Float_t         L1Mu_ptUnconstrained[15];   //[nL1Mu]
   Int_t           nL1Tau;
   ...
   Bool_t          ScoutingElectron_rechitZeroSuppression[12];   //[nScoutingElectron]
   Int_t           ScoutingElectron_missingHits[12];   //[nScoutingElectron]
   Int_t           ScoutingElectron_bestTrack_charge[12];   //[nScoutingElectron]
   UInt_t          ScoutingElectron_nClusters[12];   //[nScoutingElectron]
   UInt_t          ScoutingElectron_nCrystals[12];   //[nScoutingElectron]
   UInt_t          ScoutingElectron_seedId[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_corrEcalEnergyError[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_dEtaIn[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_dPhiIn[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_ecalIso[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_eta[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_hOverE[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_hcalIso[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_m[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_ooEMOop[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_phi[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_preshowerEnergy[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_pt[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_r9[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_rawEnergy[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_sMaj[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_sMin[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_sigmaIetaIeta[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_trackIso[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_trackfbrem[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_chi2overndf[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_d0[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_dz[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_eta[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_etaMode[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_pMode[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_phi[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_phiMode[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_pt[12];   //[nScoutingElectron]
   Float_t         ScoutingElectron_bestTrack_qoverpModeError[12];   //[nScoutingElectron]
   ...
   Bool_t          ScoutingMuonNoVtxDisplacedVertex_isValidVtx[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Int_t           ScoutingMuonNoVtxDisplacedVertex_ndof[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Int_t           ScoutingMuonNoVtxDisplacedVertex_tracksSize[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_chi2[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_x[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_xError[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_xyCov[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_xzCov[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_y[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_yError[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_yzCov[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_z[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Float_t         ScoutingMuonNoVtxDisplacedVertex_zError[26];   //[nScoutingMuonNoVtxDisplacedVertex]
   Int_t           nScoutingMuonNoVtx;
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_beginInner[9];   //[nScoutingMuonNoVtx]
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_beginOuter[9];   //[nScoutingMuonNoVtx]
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_beginTrackHits[9];   //[nScoutingMuonNoVtx]
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_endInner[9];   //[nScoutingMuonNoVtx]
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_endOuter[9];   //[nScoutingMuonNoVtx]
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_endTrackHits[9];   //[nScoutingMuonNoVtx]
   UChar_t         ScoutingMuonNoVtx_trk_hitPattern_hitCount[9];   //[nScoutingMuonNoVtx]
   UShort_t        ScoutingMuonNoVtx_nScoutingMuonNoVtxHitPattern[9];   //[nScoutingMuonNoVtx]
   UShort_t        ScoutingMuonNoVtx_oScoutingMuonNoVtxHitPattern[9];   //[nScoutingMuonNoVtx]
   UShort_t        ScoutingMuonNoVtx_nScoutingMuonNoVtxVtxIndx[9];   //[nScoutingMuonNoVtx]
   UShort_t        ScoutingMuonNoVtx_oScoutingMuonNoVtxVtxIndx[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_charge[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nPixelLayersWithMeasurement[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonChambers[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonChambersCSCorDT[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonExpectedMatchedStations[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonMatchedRPCLayers[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonMatchedStations[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nRecoMuonMatches[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nStandAloneMuonMatchedStations[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nTrackerLayersWithMeasurement[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nValidPixelHits[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nValidRecoMuonHits[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nValidStandAloneMuonHits[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_nValidStripHits[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_recoMuonRPClayerMask[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_recoMuonStationMask[9];   //[nScoutingMuonNoVtx]
   Int_t           ScoutingMuonNoVtx_type[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_ecalIso[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_eta[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_hcalIso[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_m[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_normchi2[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_phi[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_pt[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trackIso[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_chi2[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dsz[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dszError[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dxy[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dxyError[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dxy_dsz_cov[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dz[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_dzError[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_eta[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_lambda[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_lambdaError[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_lambda_dsz_cov[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_lambda_dxy_cov[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_lambda_phi_cov[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_ndof[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_phi[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_phiError[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_phi_dsz_cov[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_phi_dxy_cov[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_pt[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverp[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverpError[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverp_dsz_cov[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverp_dxy_cov[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverp_lambda_cov[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_qoverp_phi_cov[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_vx[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_vy[9];   //[nScoutingMuonNoVtx]
   Float_t         ScoutingMuonNoVtx_trk_vz[9];   //[nScoutingMuonNoVtx]
   Int_t           nScoutingMuonNoVtxHitPattern;
   UShort_t        ScoutingMuonNoVtxHitPattern_hitPattern[513];   //[nScoutingMuonNoVtxHitPattern]
   Int_t           nScoutingMuonNoVtxVtxIndx;
   Int_t           ScoutingMuonNoVtxVtxIndx_vtxIndx[52];   //[nScoutingMuonNoVtxVtxIndx]
   ...
   UChar_t         ScoutingMuonVtx_trk_hitPattern_beginInner[8];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_beginOuter[8];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_beginTrackHits[8];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_endInner[8];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_endOuter[8];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_endTrackHits[8];   //[nScoutingMuonVtx]
   UChar_t         ScoutingMuonVtx_trk_hitPattern_hitCount[8];   //[nScoutingMuonVtx]
   UShort_t        ScoutingMuonVtx_nScoutingMuonVtxHitPattern[8];   //[nScoutingMuonVtx]
   UShort_t        ScoutingMuonVtx_oScoutingMuonVtxHitPattern[8];   //[nScoutingMuonVtx]
   UShort_t        ScoutingMuonVtx_nScoutingMuonVtxVtxIndx[8];   //[nScoutingMuonVtx]
   UShort_t        ScoutingMuonVtx_oScoutingMuonVtxVtxIndx[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_charge[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nPixelLayersWithMeasurement[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonChambers[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonChambersCSCorDT[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonExpectedMatchedStations[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonMatchedRPCLayers[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonMatchedStations[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nRecoMuonMatches[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nStandAloneMuonMatchedStations[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nTrackerLayersWithMeasurement[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nValidPixelHits[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nValidRecoMuonHits[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nValidStandAloneMuonHits[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_nValidStripHits[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_recoMuonRPClayerMask[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_recoMuonStationMask[8];   //[nScoutingMuonVtx]
   Int_t           ScoutingMuonVtx_type[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_ecalIso[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_eta[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_hcalIso[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_m[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_normchi2[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_phi[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_pt[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trackIso[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_chi2[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dsz[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dszError[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dxy[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dxyError[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dxy_dsz_cov[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dz[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_dzError[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_eta[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_lambda[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_lambdaError[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_lambda_dsz_cov[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_lambda_dxy_cov[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_lambda_phi_cov[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_ndof[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_phi[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_phiError[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_phi_dsz_cov[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_phi_dxy_cov[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_pt[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverp[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverpError[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverp_dsz_cov[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverp_dxy_cov[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverp_lambda_cov[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_qoverp_phi_cov[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_vx[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_vy[8];   //[nScoutingMuonVtx]
   Float_t         ScoutingMuonVtx_trk_vz[8];   //[nScoutingMuonVtx]
   Int_t           nScoutingMuonVtxHitPattern;
   UShort_t        ScoutingMuonVtxHitPattern_hitPattern[456];   //[nScoutingMuonVtxHitPattern]
   Int_t           nScoutingMuonVtxVtxIndx;
   Int_t           ScoutingMuonVtxVtxIndx_vtxIndx[1];   //[nScoutingMuonVtxVtxIndx]
   Int_t           nScoutingPFJetRecluster;
   UChar_t         ScoutingPFJetRecluster_nConstituents[52];   //[nScoutingPFJetRecluster]
   Int_t           ScoutingPFJetRecluster_nCh[52];   //[nScoutingPFJetRecluster]
   Int_t           ScoutingPFJetRecluster_nElectrons[52];   //[nScoutingPFJetRecluster]
   Int_t           ScoutingPFJetRecluster_nMuons[52];   //[nScoutingPFJetRecluster]
   Int_t           ScoutingPFJetRecluster_nNh[52];   //[nScoutingPFJetRecluster]
   Int_t           ScoutingPFJetRecluster_nPhotons[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_area[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_chEmEF[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_chHEF[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_eta[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_hfEmEF[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_hfHEF[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_mass[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_muEF[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_neEmEF[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_neHEF[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_phi[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_pt[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_b[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_bb[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_c[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_cc[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_g[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_uds[52];   //[nScoutingPFJetRecluster]
   Float_t         ScoutingPFJetRecluster_particleNet_prob_undef[52];   //[nScoutingPFJetRecluster]
   Int_t           nScoutingPFJet;
   Int_t           ScoutingPFJet_HFEMMultiplicity[108];   //[nScoutingPFJet]
   Int_t           ScoutingPFJet_HFHadronMultiplicity[108];   //[nScoutingPFJet]
   Int_t           ScoutingPFJet_chargedHadronMultiplicity[108];   //[nScoutingPFJet]
   Int_t           ScoutingPFJet_electronMultiplicity[108];   //[nScoutingPFJet]
   Int_t           ScoutingPFJet_muonMultiplicity[108];   //[nScoutingPFJet]
   Int_t           ScoutingPFJet_neutralHadronMultiplicity[108];   //[nScoutingPFJet]
   Int_t           ScoutingPFJet_photonMultiplicity[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_HFEMEnergy[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_HFHadronEnergy[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_HOEnergy[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_chargedHadronEnergy[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_electronEnergy[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_eta[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_jetArea[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_m[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_muonEnergy[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_neutralHadronEnergy[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_phi[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_photonEnergy[108];   //[nScoutingPFJet]
   Float_t         ScoutingPFJet_pt[108];   //[nScoutingPFJet]
   Int_t           nScoutingPhoton;
   Bool_t          ScoutingPhoton_rechitZeroSuppression[36];   //[nScoutingPhoton]
   UInt_t          ScoutingPhoton_nClusters[36];   //[nScoutingPhoton]
   UInt_t          ScoutingPhoton_nCrystals[36];   //[nScoutingPhoton]
   UInt_t          ScoutingPhoton_seedId[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_corrEcalEnergyError[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_ecalIso[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_eta[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_hOverE[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_hcalIso[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_m[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_phi[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_preshowerEnergy[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_pt[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_r9[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_rawEnergy[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_sMaj[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_sMin[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_sigmaIetaIeta[36];   //[nScoutingPhoton]
   Float_t         ScoutingPhoton_trkIso[36];   //[nScoutingPhoton]
   Int_t           nScoutingPrimaryVertex;
   Bool_t          ScoutingPrimaryVertex_isValidVtx[64];   //[nScoutingPrimaryVertex]
   Int_t           ScoutingPrimaryVertex_ndof[64];   //[nScoutingPrimaryVertex]
   Int_t           ScoutingPrimaryVertex_tracksSize[64];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_chi2[64];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_x[64];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_xError[64];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_xyCov[64];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_xzCov[64];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_y[64];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_yError[64];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_yzCov[64];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_z[64];   //[nScoutingPrimaryVertex]
   Float_t         ScoutingPrimaryVertex_zError[64];   //[nScoutingPrimaryVertex]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("root://cms-xrd-global.cern.ch//store/data/Run2024I/ScoutingPFRun3/NANOAOD/ScoutNano-v1/110000/00159231-4462-4181-8ef9-9b0d34f19edc.root/Events");
      tree = chain;
#endif // SINGLE_TREE
