...
// Wed Feb 25 10:44:57 2026 by ROOT version 6.32.13
// from TChain Events/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nCorrT1METJet;
   Float_t         CorrT1METJet_EmEF[16];   //[nCorrT1METJet]
   ...
   Bool_t          Electron_isEB[8];   //[nElectron]
   Bool_t          Electron_isEcalDriven[8];   //[nElectron]
   ...
   Bool_t          Electron_mvaIso_WPHZZ[8];   //[nElectron]
   ...
   Short_t         Electron_seediEtaOriX[8];   //[nElectron]
   Short_t         Electron_seediPhiOriY[8];   //[nElectron]
   ...
   Float_t         Electron_PreshowerEnergy[8];   //[nElectron]
   ...
   Float_t         Electron_ecalEnergy[8];   //[nElectron]
   Float_t         Electron_ecalEnergyError[8];   //[nElectron]
   Float_t         Electron_energyErr[8];   //[nElectron]
   Float_t         Electron_eta[8];   //[nElectron]
   Float_t         Electron_fbrem[8];   //[nElectron]
   Float_t         Electron_gsfTrketaMode[8];   //[nElectron]
   Float_t         Electron_gsfTrkpMode[8];   //[nElectron]
   Float_t         Electron_gsfTrkpModeErr[8];   //[nElectron]
   Float_t         Electron_gsfTrkphiMode[8];   //[nElectron]
   ...
   Float_t         Electron_rawEnergy[8];   //[nElectron]
   Float_t         Electron_scEtOverPt[8];   //[nElectron]
   Float_t         Electron_sieie[8];   //[nElectron]
   Float_t         Electron_sip3d[8];   //[nElectron]
   Float_t         Electron_promptMVA[8];   //[nElectron]
   Int_t           nFatJet;
   UChar_t         FatJet_jetId[7];   //[nFatJet]
   UChar_t         FatJet_nConstituents[7];   //[nFatJet]
   Short_t         FatJet_chMultiplicity[7];   //[nFatJet]
   Short_t         FatJet_neMultiplicity[7];   //[nFatJet]
   Short_t         FatJet_subJetIdx1[7];   //[nFatJet]
   Short_t         FatJet_subJetIdx2[7];   //[nFatJet]
   Short_t         FatJet_electronIdx3SJ[7];   //[nFatJet]
   Short_t         FatJet_muonIdx3SJ[7];   //[nFatJet]
   ...
   Float_t         FatJet_muEF[7];   //[nFatJet]
   Float_t         FatJet_n2b1[7];   //[nFatJet]
   Float_t         FatJet_n3b1[7];   //[nFatJet]
   Float_t         FatJet_neEmEF[7];   //[nFatJet]
   Float_t         FatJet_neHEF[7];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_QCD[7];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_Xbb[7];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_Xcc[7];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_Xqq[7];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_mass[7];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_H4qvsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_HbbvsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_HccvsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_QCD[7];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_TvsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_WvsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_ZvsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD[7];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD0HF[7];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD1HF[7];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD2HF[7];   //[nFatJet]
   Float_t         FatJet_particleNet_XbbVsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNet_XccVsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNet_XggVsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNet_XqqVsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNet_XteVsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNet_XtmVsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNet_XttVsQCD[7];   //[nFatJet]
   Float_t         FatJet_particleNet_massCorr[7];   //[nFatJet]
   ...
   Int_t           nGenPart;
   Short_t         GenPart_genPartIdxMother[271];   //[nGenPart]
   UShort_t        GenPart_statusFlags[271];   //[nGenPart]
   Int_t           GenPart_pdgId[271];   //[nGenPart]
   Int_t           GenPart_status[271];   //[nGenPart]
   Float_t         GenPart_eta[271];   //[nGenPart]
   Float_t         GenPart_mass[271];   //[nGenPart]
   Float_t         GenPart_phi[271];   //[nGenPart]
   Float_t         GenPart_pt[271];   //[nGenPart]
   Float_t         GenPart_iso[271];   //[nGenPart]
   Int_t           nGenProton;
   ...
   Int_t           nIsoTrack;
   Bool_t          IsoTrack_isHighPurityTrack[40];   //[nIsoTrack]
   Bool_t          IsoTrack_isPFcand[40];   //[nIsoTrack]
   Bool_t          IsoTrack_isFromLostTrack[40];   //[nIsoTrack]
   Short_t         IsoTrack_charge[40];   //[nIsoTrack]
   Short_t         IsoTrack_fromPV[40];   //[nIsoTrack]
   Int_t           IsoTrack_pdgId[40];   //[nIsoTrack]
   Float_t         IsoTrack_dxy[40];   //[nIsoTrack]
   Float_t         IsoTrack_dz[40];   //[nIsoTrack]
   Float_t         IsoTrack_eta[40];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_all[40];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_chg[40];   //[nIsoTrack]
   Float_t         IsoTrack_phi[40];   //[nIsoTrack]
   Float_t         IsoTrack_pt[40];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_all[40];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_chg[40];   //[nIsoTrack]
   Int_t           nJet;
   UChar_t         Jet_chMultiplicity[23];   //[nJet]
   UChar_t         Jet_jetId[23];   //[nJet]
   UChar_t         Jet_nConstituents[23];   //[nJet]
   UChar_t         Jet_nElectrons[23];   //[nJet]
   UChar_t         Jet_nMuons[23];   //[nJet]
   UChar_t         Jet_nSVs[23];   //[nJet]
   UChar_t         Jet_neMultiplicity[23];   //[nJet]
   Short_t         Jet_electronIdx1[23];   //[nJet]
   Short_t         Jet_electronIdx2[23];   //[nJet]
   Short_t         Jet_muonIdx1[23];   //[nJet]
   Short_t         Jet_muonIdx2[23];   //[nJet]
   Short_t         Jet_svIdx1[23];   //[nJet]
   Short_t         Jet_svIdx2[23];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[23];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[23];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorr[23];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorrNeutrino[23];   //[nJet]
   Float_t         Jet_PNetRegPtRawRes[23];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorr[23];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorrNeutrino[23];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawRes[23];   //[nJet]
   ...
   Float_t         Jet_btagPNetB[23];   //[nJet]
   Float_t         Jet_btagPNetCvB[23];   //[nJet]
   Float_t         Jet_btagPNetCvL[23];   //[nJet]
   Float_t         Jet_btagPNetCvNotB[23];   //[nJet]
   Float_t         Jet_btagPNetQvG[23];   //[nJet]
   Float_t         Jet_btagPNetTauVJet[23];   //[nJet]
   Float_t         Jet_btagUParTAK4B[23];   //[nJet]
   Float_t         Jet_btagUParTAK4CvB[23];   //[nJet]
   Float_t         Jet_btagUParTAK4CvL[23];   //[nJet]
   Float_t         Jet_btagUParTAK4CvNotB[23];   //[nJet]
   Float_t         Jet_btagUParTAK4QvG[23];   //[nJet]
   Float_t         Jet_btagUParTAK4TauVJet[23];   //[nJet]
   Float_t         Jet_chEmEF[23];   //[nJet]
   Float_t         Jet_chHEF[23];   //[nJet]
   Float_t         Jet_eta[23];   //[nJet]
   Float_t         Jet_hfEmEF[23];   //[nJet]
   Float_t         Jet_hfHEF[23];   //[nJet]
   ...
   Float_t         GenMET_pt;
   Int_t           nMuon;
   UChar_t         Muon_highPtId[46];   //[nMuon]
   Bool_t          Muon_highPurity[46];   //[nMuon]
   Bool_t          Muon_inTimeMuon[46];   //[nMuon]
   Bool_t          Muon_isGlobal[46];   //[nMuon]
   Bool_t          Muon_isPFcand[46];   //[nMuon]
   Bool_t          Muon_isStandalone[46];   //[nMuon]
   Bool_t          Muon_isTracker[46];   //[nMuon]
   UChar_t         Muon_jetNDauCharged[46];   //[nMuon]
   Bool_t          Muon_looseId[46];   //[nMuon]
   Bool_t          Muon_mediumId[46];   //[nMuon]
   Bool_t          Muon_mediumPromptId[46];   //[nMuon]
   UChar_t         Muon_miniIsoId[46];   //[nMuon]
   UChar_t         Muon_multiIsoId[46];   //[nMuon]
   UChar_t         Muon_mvaMuID_WP[46];   //[nMuon]
   UChar_t         Muon_nStations[46];   //[nMuon]
   UChar_t         Muon_nTrackerLayers[46];   //[nMuon]
   UChar_t         Muon_pfIsoId[46];   //[nMuon]
   UChar_t         Muon_puppiIsoId[46];   //[nMuon]
   Bool_t          Muon_softId[46];   //[nMuon]
   Bool_t          Muon_softMvaId[46];   //[nMuon]
   UChar_t         Muon_tightCharge[46];   //[nMuon]
   Bool_t          Muon_tightId[46];   //[nMuon]
   UChar_t         Muon_tkIsoId[46];   //[nMuon]
   Bool_t          Muon_triggerIdLoose[46];   //[nMuon]
   Short_t         Muon_jetIdx[46];   //[nMuon]
   Short_t         Muon_svIdx[46];   //[nMuon]
   Short_t         Muon_fsrPhotonIdx[46];   //[nMuon]
   Int_t           Muon_charge[46];   //[nMuon]
   Int_t           Muon_pdgId[46];   //[nMuon]
   Float_t         Muon_dxy[46];   //[nMuon]
   Float_t         Muon_dxyErr[46];   //[nMuon]
   Float_t         Muon_dxybs[46];   //[nMuon]
   Float_t         Muon_dz[46];   //[nMuon]
   Float_t         Muon_dzErr[46];   //[nMuon]
   Float_t         Muon_eta[46];   //[nMuon]
   Float_t         Muon_ip3d[46];   //[nMuon]
   Float_t         Muon_jetPtRelv2[46];   //[nMuon]
   Float_t         Muon_jetRelIso[46];   //[nMuon]
   Float_t         Muon_mass[46];   //[nMuon]
   Float_t         Muon_miniPFRelIso_all[46];   //[nMuon]
   Float_t         Muon_miniPFRelIso_chg[46];   //[nMuon]
   Float_t         Muon_mvaMuID[46];   //[nMuon]
   Float_t         Muon_pfRelIso03_all[46];   //[nMuon]
   Float_t         Muon_pfRelIso03_chg[46];   //[nMuon]
   Float_t         Muon_pfRelIso04_all[46];   //[nMuon]
   Float_t         Muon_phi[46];   //[nMuon]
   Float_t         Muon_pt[46];   //[nMuon]
   Float_t         Muon_ptErr[46];   //[nMuon]
   Float_t         Muon_segmentComp[46];   //[nMuon]
   Float_t         Muon_sip3d[46];   //[nMuon]
   Float_t         Muon_softMva[46];   //[nMuon]
   Float_t         Muon_softMvaRun3[46];   //[nMuon]
   Float_t         Muon_tkRelIso[46];   //[nMuon]
   Float_t         Muon_tunepRelPt[46];   //[nMuon]
   Float_t         Muon_bsConstrainedChi2[46];   //[nMuon]
   Float_t         Muon_bsConstrainedPt[46];   //[nMuon]
   Float_t         Muon_bsConstrainedPtErr[46];   //[nMuon]
   Float_t         Muon_mvaLowPt[46];   //[nMuon]
   Float_t         Muon_promptMVA[46];   //[nMuon]
   Float_t         PFMET_covXX;
   Float_t         PFMET_covXY;
   Float_t         PFMET_covYY;
   Float_t         PFMET_phi;
   ...
   Int_t           nSubJet;
   Float_t         SubJet_area[18];   //[nSubJet]
   Float_t         SubJet_btagDeepB[18];   //[nSubJet]
   Float_t         SubJet_eta[18];   //[nSubJet]
   Float_t         SubJet_mass[18];   //[nSubJet]
   Float_t         SubJet_n2b1[18];   //[nSubJet]
   Float_t         SubJet_n3b1[18];   //[nSubJet]
   Float_t         SubJet_phi[18];   //[nSubJet]
   Float_t         SubJet_pt[18];   //[nSubJet]
   Float_t         SubJet_rawFactor[18];   //[nSubJet]
   Float_t         SubJet_tau1[18];   //[nSubJet]
   Float_t         SubJet_tau2[18];   //[nSubJet]
   Float_t         SubJet_tau3[18];   //[nSubJet]
   Float_t         SubJet_tau4[18];   //[nSubJet]
   Int_t           nTauProd;
   ...
   Int_t           nTrigObj;
   Short_t         TrigObj_l1charge[131];   //[nTrigObj]
   UShort_t        TrigObj_id[131];   //[nTrigObj]
   Int_t           TrigObj_l1iso[131];   //[nTrigObj]
   Int_t           TrigObj_filterBits[131];   //[nTrigObj]
   Float_t         TrigObj_pt[131];   //[nTrigObj]
   Float_t         TrigObj_eta[131];   //[nTrigObj]
   Float_t         TrigObj_phi[131];   //[nTrigObj]
   Float_t         TrigObj_l1pt[131];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[131];   //[nTrigObj]
   Float_t         TrigObj_l2pt[131];   //[nTrigObj]
   Float_t         TrkMET_phi;
   Float_t         TrkMET_pt;
   ...
   Float_t         PV_sumpy;
   Int_t           nSV;
   Short_t         SV_charge[36];   //[nSV]
   Float_t         SV_dlen[36];   //[nSV]
   Float_t         SV_dlenSig[36];   //[nSV]
   Float_t         SV_dxy[36];   //[nSV]
   Float_t         SV_dxySig[36];   //[nSV]
   Float_t         SV_pAngle[36];   //[nSV]
   ...
   Short_t         Electron_genPartIdx[8];   //[nElectron]
   Float_t         Electron_IPx[8];   //[nElectron]
   Float_t         Electron_IPy[8];   //[nElectron]
   Float_t         Electron_IPz[8];   //[nElectron]
   Float_t         Electron_ipLengthSig[8];   //[nElectron]
   UChar_t         FatJet_hadronFlavour[7];   //[nFatJet]
   Short_t         FatJet_genJetAK8Idx[7];   //[nFatJet]
   UChar_t         GenJetAK8_hadronFlavour[9];   //[nGenJetAK8]
   UChar_t         GenJetAK8_nBHadrons[9];   //[nGenJetAK8]
   UChar_t         GenJetAK8_nCHadrons[9];   //[nGenJetAK8]
   Short_t         GenJetAK8_partonFlavour[9];   //[nGenJetAK8]
   UChar_t         GenJet_hadronFlavour[21];   //[nGenJet]
   UChar_t         GenJet_nBHadrons[21];   //[nGenJet]
   UChar_t         GenJet_nCHadrons[21];   //[nGenJet]
   Short_t         GenJet_partonFlavour[21];   //[nGenJet]
   Float_t         GenVtx_t0;
   UChar_t         Jet_hadronFlavour[23];   //[nJet]
   Short_t         Jet_genJetIdx[23];   //[nJet]
   Short_t         Jet_partonFlavour[23];   //[nJet]
   UChar_t         LowPtElectron_genPartFlav[9];   //[nLowPtElectron]
   Short_t         LowPtElectron_genPartIdx[9];   //[nLowPtElectron]
   UChar_t         Muon_genPartFlav[46];   //[nMuon]
   Short_t         Muon_genPartIdx[46];   //[nMuon]
   Float_t         Muon_IPx[46];   //[nMuon]
   Float_t         Muon_IPy[46];   //[nMuon]
   Float_t         Muon_IPz[46];   //[nMuon]
   Float_t         Muon_ipLengthSig[46];   //[nMuon]
   UChar_t         Photon_genPartFlav[9];   //[nPhoton]
   Short_t         Photon_genPartIdx[9];   //[nPhoton]
   UChar_t         SubJet_hadronFlavour[18];   //[nSubJet]
   UChar_t         SubJet_nBHadrons[18];   //[nSubJet]
   UChar_t         SubJet_nCHadrons[18];   //[nSubJet]
   UChar_t         SV_ntracks[36];   //[nSV]
   Float_t         SV_chi2[36];   //[nSV]
   Float_t         SV_eta[36];   //[nSV]
   Float_t         SV_mass[36];   //[nSV]
   Float_t         SV_ndof[36];   //[nSV]
   Float_t         SV_phi[36];   //[nSV]
   Float_t         SV_pt[36];   //[nSV]
   Float_t         SV_x[36];   //[nSV]
   Float_t         SV_y[36];   //[nSV]
   Float_t         SV_z[36];   //[nSV]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("root://cmsxrootd.fnal.gov//store/mc/RunIII2024Summer24NanoAOD/QCD_Bin-PT-3000_TuneCP5_13p6TeV_pythia8/NANOAODSIM/140X_mcRun3_2024_realistic_v26-v2/130000/7c1235cb-0d5f-4351-b9e9-129bf3732368.root/Events");
      tree = chain;
#endif // SINGLE_TREE
